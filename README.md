...
- weight: Body weight (continuous variable, in kg)
- total_length: Total body length (continuous variable, in cm)
- wither_height: Height at the withers (continuous variable, in cm)
- neck_size: Neck circumference (continuous variable, in cm)
- temperature: Body temperature (continuous variable, in °C)
- hematocrit: Hematocrit level (continuous variable, in %)
